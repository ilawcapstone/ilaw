...
<?php $this->load->view("inc/nav-student"); ?>
	...
	<div class="container">
		<div class="uk-background-cover" style="background-image: url(<?php echo base_url(); ?>assets/image/ddd.jpg);">
		<div class="uk-child-width-expand@s uk-text-center uk-grid-collapse" uk-grid>
			...
			<div class="margin_all_10px">
				...
				<IMG STYLE="position:absolute; TOP:70px; LEFT:250px; WIDTH:300px;  
HEIGHT:100px" SRC="<?php echo base_url(); ?>assets/image/nya1.gif"> 
<IMG STYLE="position:absolute; TOP:70px; LEFT:780px; WIDTH:300px;  
HEIGHT:100px" SRC="<?php echo base_url(); ?>assets/image/nya2.gif"> 

					<h3 style="font-size:400%";>GAMES</h3>
					<div class="uk-child-width-expand@s uk-text-center uk-grid-column-small uk-grid-row-large uk-child-width-1-3@s" uk-grid id="div_display_game_data">
				...
				<div class="uk-card uk-card-mute uk-card-body main_card_height_550px">
					...
					<div class="uk-child-width-expand@s uk-text-center uk-grid-collapse" uk-grid>
						<div class="margin_all_10px">
					        <div class="uk-card uk-card-default uk-card-body card_height_450px">
							...
							<div class="uk-card uk-card-default uk-card-body card_height_450px">
					        	<div class="uk-animation-toggle" tabindex="0">
					        		<a href="<?php echo base_url('cn/book'); ?>">
								        <div class="uk-inline-clip uk-transition-toggle" tabindex="0">
								            <img src="<?php echo base_url(); ?>assets/image/main/main_book.jpg" alt="">
								            <div class="uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-default">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on('click', '.btnDisplayGame', function(){
			...
			$.ajax({
				type: "GET",
				url: "<?php echo base_url('cn/display_game_data_by_category_id/'); ?>" + categoryId,
				data: {},
				success: function(data){
					...
					if(data.length > 0){
						...
						setTimeout(function(){
							...
							window.location = '<?php echo base_url() ?>cn/games';
			...
			$.ajax({
				...
				success: function(data){
					...
					for(var i = 0; i < data.length; i++){
						...
						output +='<div uk-tooltip="'+ data[i].GameCategoryName +'" class="uk-animation-toggle" tabindex="0">' +
								'		<div class="uk-animation-slide-left-small">' +
								'     		<a class="btnDisplayGame" data-id="'+ data[i].GameCategoryId +'">' +
								'		        <div class="border_radius_15px uk-background-cover-with-radius uk-height-medium uk-width-medium uk-panel uk-flex uk-flex-center uk-flex-middle" style="background-image: url(<?php echo base_url() ?>'+ data[i].GameCategoryPictureFileName +');">' +
								'		        </div>' +
								'      		</a>' +
								'  		</div>' +
								' </div>';
